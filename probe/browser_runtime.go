...
type BrowserRuntime struct {
	runtime *Runtime
	factory *browserruntime.Factory
}
...
func NewBrowserRuntime(config BrowserRuntimeConfig) (*BrowserRuntime, error) {
	return newBrowserRuntime(config, browserRuntimeFactories{
		factory:  browserruntime.NewFromEnvironment,
		executor: NewCGVExecutor,
	})
}

type browserRuntimeFactories struct {
	factory  func(string) (*browserruntime.Factory, error)
	executor func(*browserruntime.Factory) (*CGVExecutor, error)
}
